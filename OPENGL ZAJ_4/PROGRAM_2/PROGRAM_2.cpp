...
void GenerateTextures()
{
	...
	GLboolean error = load_targa("grass_messy_20160504_2048548355.tga", width, height, format, type, pixels);
	...
	error = load_targa("maple_tree_no_leaves_20150403_1594705210.tga", width, height, format, type, pixels);
